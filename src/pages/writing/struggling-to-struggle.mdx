...
export default (props) => (
  <ArticleLayout
    title={"Less is more. It is also extremely hard."}
    date={"15 April, 2023"}
    {...props}
  />
);
...
Like my thesis. Holy crap I have so much to do, I'm so screwed. Well, that seems like a good note to end on.
